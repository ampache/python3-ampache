...
def cache_playlist(ampache_url, ampache_api, ampache_user, api_format, smartlist, destination, transcode, limit):
    ...
    """ handshake
    def handshake(ampache_url, ampache_api, user = False, timestamp = False, version = '5.5.6'):
    # processed details
    """
    ampache_session = ampacheConnection.handshake(ampache_url, encrypted_key, '', 0, '5.5.6')
