...
def self_check(api_format, ampache_url, ampache_api, ampache_session):
    ...
    for files in os.listdir("./docs/" + api_format + "-responses/"):
        ...
        newdata = re.sub("\"creation_date\": \".*\"", "\"creation_date\": \"1670202706\"", newdata)
        newdata = re.sub("<creation_date>.*</creation_date>", "<creation_date>1670202706</creation_date>", newdata)
